...
- Some default styles was applied, check the [`styles`](https://github.com/birdra1n/electron-shadcn/tree/main/src/styles) directory
...
```bash
git clone https://github.com/birdra1n/electron-shadcn.git
```
